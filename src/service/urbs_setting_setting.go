...
// SettingList ...
func (a *UrbsSetting) SettingList(ctx context.Context, args *urbssetting.ProductModulePaginationURL) (*urbssetting.SettingsInfoRes, error) {
...
// SettingCreate ...
func (a *UrbsSetting) SettingCreate(ctx context.Context, args *urbssetting.ProductModuleURL, body *urbssetting.NameDescBody) (*urbssetting.SettingInfoRes, error) {
...
// SettingGet ...
func (a *UrbsSetting) SettingGet(ctx context.Context, args *urbssetting.ProductModuleSettingURL) (*urbssetting.SettingInfoRes, error) {
...
// SettingUpdate ...
func (a *UrbsSetting) SettingUpdate(ctx context.Context, args *urbssetting.ProductModuleSettingURL, body *urbssetting.SettingUpdateBody) (*urbssetting.SettingInfoRes, error) {
	url := fmt.Sprintf("%s/v1/products/%s/modules/%s/settings/%s", conf.Config.UrbsSetting.Addr, args.Product, args.Module, args.Setting)
...
// SettingOffline ...
func (a *UrbsSetting) SettingOffline(ctx context.Context, args *urbssetting.ProductModuleSettingURL) (*urbssetting.BoolRes, error) {
...
// SettingAssign ...
func (a *UrbsSetting) SettingAssign(ctx context.Context, args *urbssetting.ProductModuleSettingURL) (*urbssetting.BoolRes, error) {
	...
	resp, err := request.Post(url).Header(UrbsSettingHeader(ctx)).Result(result).Do()
