...
func TestAPIsAuth(t *testing.T) {
	...
	reqArgs := []reqArg{
		...
		{Method: http.MethodPut, URL: "/api/v1/products/product", Body: `{"uids":[""]}`},
		...
		{Method: http.MethodPost, URL: "/api/v1/products/product/labels", Body: `{"name":"name","uids":[""]}`},
		...
		{Method: http.MethodPost, URL: "/api/v1/products/product/modules", Body: `{"name":"xcccc","uids":[""]}`},
		{Method: http.MethodPut, URL: "/api/v1/products/product/modules/module", Body: `{"name":"xcccc","uids":[""]}`},
		...
		{Method: http.MethodPost, URL: "/api/v1/products/product/modules/module/settings", Body: `{"name":"xxxx","uids":[""]}`},
		{Method: http.MethodPut, URL: "/api/v1/products/product/modules/module/settings/setting", Body: `{"desc":"xxxx","uids":[""]}`},
